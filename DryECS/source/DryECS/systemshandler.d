...
string GenUpdate()
{
    ...
    int id = 0;
    func.put(_GenModuleUpdate!(DryECS.systems.transformsystem)(knownComponents, componentIds));
    func.put(_GenModuleUpdate!(DryECS.systems.camerasystem)(knownComponents, componentIds));
